$(document).ready(function () {
  ...
  $(".navbar-toggler").click(function (e) {
    ...
    if ($(".navbar-collapse").hasClass("show")) {
      ...
      $(".navbar-toggler img").attr("src", "./assets/img/btn-fermer-blanc.png");
    }
  });
  /* our programee hover script */
  $(".our-programmes-inner").hover(function () {
    // over
    let myPara = $(this).children(".my-progrmmes-inner").children("div").children("p");
    let myImg = $(this).children(".my-progrmmes-inner").children("div").children("a").children("img");
    myImg.css("opacity", "1");
